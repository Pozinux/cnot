...
function removedossier(dossier_to_remove){
    ...
    {
        var r = confirm("Êtes-vous sûr de vouloir supprimer définitivement le dossier \""+dossier_to_remove+"\" et toutes ses notes (même celle de ce dossier qui sont dans la corbeille ? Elles seront perdues à jamais !");
        if (r == true) {
