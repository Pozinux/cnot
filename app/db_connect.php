...
$query='CREATE TABLE IF NOT EXISTS entries (id int(11) UNSIGNED AUTO_INCREMENT PRIMARY KEY,trash int(11) DEFAULT 0, heading text,entry mediumtext,created TIMESTAMP DEFAULT CURRENT_TIMESTAMP,updated TIMESTAMP, dossier text, sousdossier text, tags text)';
$con->query($query);
